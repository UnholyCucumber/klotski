...
def read_puzzle(id):
    ...
    with open('puzzle' + str(id) + '.txt') as f:
        for i in range(5):
            for j in range(4):
...
if debug:
    ...
    succ = get_successor(test_state10, vertical_blocks)
...
# print out solution for A*
fastar1 = open("puzzle1sol_astar.txt","w+")

fastar1.write("Initial state:\n")
for i in range(5):
    for j in range(4):
        fastar1.write(str(soln1_astar[1][0][i][j]))
    fastar1.write("\n")

fastar1.write("\n")
fastar1.write("Cost of solution: ")
fastar1.write(str(get_cost(soln1_astar[1])))
fastar1.write("\n")
fastar1.write("\n")
fastar1.write("Number of states expanded: ")
fastar1.write(str(num_expanded1_astar))
fastar1.write("\n")
fastar1.write("\n")
fastar1.write("Solution:")
fastar1.write("\n")
fastar1.write("\n")

for x in range(get_cost(soln1_astar[1])+1):
    fastar1.write(str(x))
    fastar1.write('\n')
    for i in range(5):
        for j in range(4):
            fastar1.write(str(soln1_astar[1][x][i][j]))
        fastar1.write("\n")
    fastar1.write("\n")
...
# print out solution for dfs
fdfs1 = open("puzzle1sol_dfs.txt","w+")

fdfs1.write("Initial state:\n")
for i in range(5):
    for j in range(4):
        fdfs1.write(str(soln1_dfs[0][i][j]))
    fdfs1.write("\n")

fdfs1.write("\n")
fdfs1.write("Cost of solution: ")
fdfs1.write(str(get_cost(soln1_dfs)))
fdfs1.write("\n")
fdfs1.write("\n")
fdfs1.write("Number of states expanded: ")
fdfs1.write(str(num_expanded1_dfs))
fdfs1.write("\n")
fdfs1.write("\n")
fdfs1.write("Solution:")
fdfs1.write("\n")
fdfs1.write("\n")

for x in range(get_cost(soln1_dfs)+1):
    fdfs1.write(str(x))
    fdfs1.write('\n')
    for i in range(5):
        for j in range(4):
            fdfs1.write(str(soln1_dfs[x][i][j]))
        fdfs1.write("\n")
    fdfs1.write("\n")

# take in second puzzle
puzzle2=read_puzzle(2)

# find all vertical 1 x 2 blocks
vertical_blocks = find_vertical(puzzle2)

# run A* on the second puzzle
soln2_astar, num_expanded2_astar = a_star(puzzle2)

# print out solution for A*
fastar2 = open("puzzle2sol_astar.txt","w+")

fastar2.write("Initial state:\n")
for i in range(5):
    for j in range(4):
        fastar2.write(str(soln2_astar[1][0][i][j]))
    fastar2.write("\n")

fastar2.write("\n")
fastar2.write("Cost of solution: ")
fastar2.write(str(get_cost(soln2_astar[1])))
fastar2.write("\n")
fastar2.write("\n")
fastar2.write("Number of states expanded: ")
fastar2.write(str(num_expanded2_astar))
fastar2.write("\n")
fastar2.write("\n")
fastar2.write("Solution:")
fastar2.write("\n")
fastar2.write("\n")

for x in range(get_cost(soln2_astar[1])+1):
    fastar2.write(str(x))
    fastar2.write('\n')
    for i in range(5):
        for j in range(4):
            fastar2.write(str(soln2_astar[1][x][i][j]))
        fastar2.write("\n")
    fastar2.write("\n")

# run dfs on the first puzzle
soln2_dfs, num_expanded2_dfs = dfs(puzzle2)

# print out solution for dfs
fdfs2 = open("puzzle2sol_dfs.txt","w+")

fdfs2.write("Initial state:\n")
for i in range(5):
    for j in range(4):
        fdfs2.write(str(soln2_dfs[0][i][j]))
    fdfs2.write("\n")

fdfs2.write("\n")
fdfs2.write("Cost of solution: ")
fdfs2.write(str(get_cost(soln2_dfs)))
fdfs2.write("\n")
fdfs2.write("\n")
fdfs2.write("Number of states expanded: ")
fdfs2.write(str(num_expanded2_dfs))
fdfs2.write("\n")
fdfs2.write("\n")
fdfs2.write("Solution:")
fdfs2.write("\n")
fdfs2.write("\n")

for x in range(get_cost(soln2_dfs)+1):
    fdfs2.write(str(x))
    fdfs2.write('\n')
    for i in range(5):
        for j in range(4):
            fdfs2.write(str(soln2_dfs[x][i][j]))
        fdfs2.write("\n")
    fdfs2.write("\n")
